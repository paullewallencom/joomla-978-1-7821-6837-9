...
<form action="<?php echo JRoute::_('http://localhost/joomla3/index.php?option=com_folio&view=updfolio&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
